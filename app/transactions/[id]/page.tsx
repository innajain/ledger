...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  const txn = await prisma.transaction.findUnique({
    ...
    include: {
      ...
      asset_trade_txn: { include: { asset_replacement_in_purpose_buckets: { include: { purpose_bucket: true } }, debit_account: true, credit_account: true, debit_asset: true, credit_asset: true } },
    },
  });
